...
prefix = /home/liping/wifidog-master/install
exec_prefix = ${prefix}
...
ACLOCAL = /home/liping/wifidog-master/config/missing aclocal-1.4
AUTOCONF = autoconf
AUTOMAKE = /home/liping/wifidog-master/config/missing automake-1.4
...
LTLIB = @LTLIB@
MAINT = #
MAKEINFO = /home/liping/wifidog-master/config/missing makeinfo
NMEDIT = 
OBJDUMP = @OBJDUMP@
OBJEXT = o
PACKAGE = wifidog
...
EXTRA_DIST =    FAQ   wifidog.spec.in   wifidog.spec   config   scripts   contrib   wifidog.conf
...
configure.in wifidog-msg.html.in wifidog.spec.in
...
wifidog.spec: $(top_builddir)/config.status wifidog.spec.in
	cd $(top_builddir) && CONFIG_FILES=$@ CONFIG_HEADERS= $(SHELL) ./config.status
wifidog-msg.html: $(top_builddir)/config.status wifidog-msg.html.in
	cd $(top_builddir) && CONFIG_FILES=$@ CONFIG_HEADERS= $(SHELL) ./config.status
